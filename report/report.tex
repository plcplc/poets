...
\cite{hvitved10}. %In Section bla we will go through bla and Section n will describe our bla.
...
could occur in real world applications. \fxnote{applications burde måske
...
%See how this could be implemented in Appendix \ref{}
...
\begin{figure}
  \begin{align*}[box=\widefbox]
    ...
    e ::= &~ \ldots || \lambda id_1~ id_2~ \ldots~ id_n -> e || e_1\ e_2 || \kw{if}~ c~ \kw{then}~ e_1~ \kw{else}~ e_2 %\tag{CSL predicates} 
