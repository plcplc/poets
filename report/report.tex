...
should be. \fxnote{reformulate} Section \ref{implementation} describes how we have
...
not allow recursion. This would break \ldots \fxwarning{hvorfor var
  det nu lige?}.  Instead we need a way of iterating through lists
