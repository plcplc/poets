...
\end{lstlisting}
The most important extesion to this class is the environment, such that
...
ensure the integrity of the environment through the calculation. 
The
complete algebra for the evaluation of lamba expressions is:
\begin{lstlisting}
...
\lstinline{EValue} function type \lstinline{f -> e}.
